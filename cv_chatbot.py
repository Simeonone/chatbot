...
# Main chat loop
print("AI Chatbot: Hello! I'm Simeon's AI-powered chatbot. What would you like to know about his AI expertise and experience?")
while True:
    user_input = input("You: ").strip()
    if user_input.lower() in ['quit', 'exit', 'bye']:
        type_effect("AI CV Chatbot: Thank you for your interest in my AI skills and experience. I hope I've demonstrated my capabilities effectively. Goodbye!")
        break
    response = get_response(user_input)
    type_effect("AI CV Chatbot: " + response)